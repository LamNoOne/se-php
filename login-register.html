                ...
                <div class="row">
                        ...
                        <div id="login-register-container">
                                ...
                                <form action="" method="post" class="login-form">
                                    <fieldset>
                                        <div class="login-form__input-container d-flex flex-column gap-1 my-3">
                                            <label for="email" class="login-form__input__label"
                                        ...
                                        <div class="login-form__input-container d-flex flex-column gap-1 my-3">
                                            <label for="password" class="login-form__input__label"
                                        ...
                                        <div
                                            class="login-form__submit-container d-flex align-items-center justify-content-between my-4">
                                            <button type="submit" class="login-form__submit-container__submit">
                                                Sign In
                                            </button>
                                            <a class="login-form__submit-container__forgot-password" href="#"
                            ...
                            <div class="login-container p-5">
                                ...
                                <form action="" method="post" class="login-form">
                                    <fieldset>
                                        <div class="login-form__input-container d-flex flex-column gap-1 my-3">
                                            <label for="firstname" class="login-form__input__label"
                                        ...
                                        <div class="login-form__input-container d-flex flex-column gap-1 my-3">
                                            <label for="lastname" class="login-form__input__label"
                                        ...
                                        <div class="login-form__input-container d-flex flex-column gap-1 my-3">
                                            <label for="confirm_password" class="login-form__input__label"
                    ...
                    <div class="col-5">
                        <div class="login-container p-5">
                            ...
                            <div
                                class="login-question-container d-flex justify-content-between align-items-center d-none">
