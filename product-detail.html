...
<html lang="en">
                    ...
                    <div class="col">
                        <div class="checkout-container py-4 d-flex align-items-center justify-content-end gap-3">
                            <div class="product-detail__quantity d-flex align-items-center">
                                ...
                                <input
                                    class="product-detail__quantity__input ms-2"
                                    id="product-detail__quantity__input"
                                    type="number"
                                    name="quantity"
                                    value="1"
                                    min="1"
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="product-img-container">
                            <img
                                src="assets/img/product-detail.webp"
                                class="object-fit-cover product-img"
                                alt="product" />
    ...
    <script src="js/body/product-detail.js"></script>
</html>
